...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        while (opcao != 6) {
            ...
            System.out.println("2 - Buscar Professor pela Matricula");
            System.out.println("3 - Remover Professor pela Matricula");
            System.out.println("4 - Listar Todos os Professores");
            System.out.println("5 - Exibir Estatisticas Gerais");
            ...
            if (opcao == 1) {
                ...
                if (tipo == 1) {
                    professor = new ProfessorTitular(matricula, nome, horas, salario);
                    universidade.adicionarProfessor(professor);
                    System.out.println("Professor titular cadastrado.");
                } else if (tipo == 2) {
                    professor = new ProfessorSubstituto(matricula, nome, horas, salario);
                    universidade.adicionarProfessor(professor);
                ...
                if (p != null) {
                    ...
                    System.out.println("Horas semanais: " + p.getHorasSemanais());
                    System.out.println("Salario base: R$ " + p.getSalarioBase());
                    System.out.println("Salario final: R$ " + p.calcularSalarioFinal());

                    if (p.elegivelAfastamento()) {
                        System.out.println("Elegivel para afastamento: Sim");
                    } else {
                        System.out.println("Elegivel para afastamento: Nao");
                    }
                ...
                System.out.println("Professores cadastrados atualmente: "
